...
class AccountlessApiAsyncTest : IntegrationTest() {
    ...
    fun shouldLoginAsync() = runTest {
        // When
        val response = AccountlessApi.loginAsync(PLATFORM_TEST_MAIN_USER_EMAIL, TEST_MAIN_USER_PASSWORD).await()
    ...
    fun shouldRegisterAndDeleteAsync() = runTest {
        ...
        val exception = assertFailsWith(UnauthorizedException::class) {

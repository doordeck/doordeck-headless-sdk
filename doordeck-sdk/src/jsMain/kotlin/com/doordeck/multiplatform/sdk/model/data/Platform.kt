...
internal fun Platform.AuthKey.toBasicAuthKey () = when(this) {
    is Platform.RsaKey -> BasicPlatform.BasicRsaKey(kty, use, kid, alg, p, q, d, e, qi, dp, dq, n)
    is Platform.EcKey -> BasicPlatform.BasicEcKey(kty, use, kid, alg, d, crv, x, y)
    is Platform.Ed25519Key -> BasicPlatform.BasicEd25519Key(kty, use, kid, alg, d, crv, x)
}

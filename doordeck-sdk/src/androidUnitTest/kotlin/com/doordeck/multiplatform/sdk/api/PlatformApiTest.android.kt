...
class PlatformApiTest : MockTest() {
    ...
    fun shouldUpdateApplicationEmailPreferences() = runTest {
        PlatformApi.updateApplicationEmailPreferences(DEFAULT_APPLICATION_ID, BasicPlatformOperations.BasicEmailPreferences())
    }

    @Test
    fun shouldUpdateApplicationEmailPreferencesAsync() = runTest {
        PlatformApi.updateApplicationEmailPreferencesAsync(DEFAULT_APPLICATION_ID, BasicPlatformOperations.BasicEmailPreferences()).await()
    }
    ...
    fun shouldAddAuthKey() = runTest {
        PlatformApi.addAuthKey(DEFAULT_APPLICATION_ID, BasicPlatformOperations.BasicEcKey(use = "", kid = "", d = "", crv = "", x = "", y = ""))
    }

    @Test
    fun shouldAddAuthKeyAsync() = runTest {
        PlatformApi.addAuthKeyAsync(DEFAULT_APPLICATION_ID, BasicPlatformOperations.BasicEcKey(use = "", kid = "", d = "", crv = "", x = "", y = "")).await()
    }

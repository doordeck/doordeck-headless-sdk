...
actual object PlatformApi {
     ...
     */
    @DoordeckOnly
    fun getApplicationAsync(applicationId: String): CompletableFuture<Application> {
     ...
     */
    @DoordeckOnly
    fun updateApplicationEmailPreferencesAsync(applicationId: String, emailPreferences: PlatformOperations.EmailPreferences): CompletableFuture<Unit> {
     ...
     */
    @DoordeckOnly
    fun getLogoUploadUrlAsync(applicationId: String, contentType: String): CompletableFuture<GetLogoUploadUrl> {
     ...
     */
    @DoordeckOnly
    fun addAuthKeyAsync(applicationId: String, key: PlatformOperations.AuthKey): CompletableFuture<Unit> {
     ...
     */
    @DoordeckOnly
    fun getApplicationOwnersDetailsAsync(applicationId: String): CompletableFuture<List<ApplicationOwnerDetails>> {

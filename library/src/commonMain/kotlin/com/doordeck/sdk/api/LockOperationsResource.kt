...
interface LockOperationsResource {
     ...
     * @see <a href="https://developer.doordeck.com/docs/#update-lock-properties">API Doc</a>
     */
    fun updateLockSettingTimeRestrictions(lockId: String, time: LockOperations.TimeRequirement? = null): EmptyResponse
     ...
     * @see <a href="https://developer.doordeck.com/docs/#update-lock-properties">API Doc</a>
     */
    fun updateLockSettingLocationRestrictions(lockId: String, location: LockOperations.LocationRequirement? = null): EmptyResponse

...
class TilesResourceImpl(
    ...
    override suspend fun associateMultipleLocks(tileId: String, siteId: String, lockIds: Array<String>) {
        return associateMultipleLocksRequest(tileId, siteId, lockIds)
    }

    override fun associateMultipleLocksFuture(tileId: String, siteId: String, lockIds: Array<String>): CompletableFuture<Unit> {
